...
- Nuked SC-55mkII (Firmware v1.01)
	- Runs: yes
	- Runs in realtime: no (Nuked-OPM still performs times worse compared to this, I have no idea if that's [Furnace](https://github.com/tildearrow/furnace/)'s problem)
