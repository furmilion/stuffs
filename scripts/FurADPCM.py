...
# когда-то, сгорела какая-то библиотека (я уже названия не помню даже)
# подожгли её с целью сокрыть от глаз людских  ужасы библиотеки сей,
# именно этого питоновского документа
# но как назло поджигальщикам, именно этот документ сумел всё-таки
# сохраниться полностью от буквы до буквы.
# когда-нибудь я его перепишу из этого ужаса в ужас чуть меньше
